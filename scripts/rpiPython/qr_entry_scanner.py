...
# Try the script's own directory first, then the parent project root.
...
def open_camera() -> cv2.VideoCapture | PiCamera2Capture:
    ...
    # On Raspberry Pi, try the CSI camera via picamera2 first — unless the user
    # has explicitly set SCANNER_CAMERA_INDEX (which means they want a specific
    # USB camera instead).
    ...
    # USB / V4L2 / platform-specific fallback
