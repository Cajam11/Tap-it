        ...
        <div className="relative z-10 mx-auto w-full max-w-5xl space-y-8">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div className="max-w-2xl space-y-3">
              ...
              <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl">Skupinové lekcie</h1>
              <p className="max-w-xl text-base text-white/60">Vyber si skupinovú lekciu, ktorú chceš rezervovať.</p>
            </div>
          ...
          {groupClasses.length === 0 ? (
            <p className="text-white/40">Zatiaľ žiadne skupinové lekcie v ponuke.</p>
          ) : (
