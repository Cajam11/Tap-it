...
export default async function MembershipDetailsPage() {
  ...
  const startDate = activeMembershipRes.data.start_date
    ? new Date(activeMembershipRes.data.start_date).toLocaleDateString(
        "sk-SK",
        {
          year: "numeric",
          month: "long",
  ...
  const features = membershipName
    ? getFeaturesByMembershipName(membershipName)
    : [];
          ...
          <section className="rounded-3xl border border-white/10 bg-white/[0.03] p-6 sm:p-8">
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="rounded-xl border border-white/10 bg-white/[0.02] p-4">
                ...
                <p className="mt-2 text-lg font-semibold text-white">
                  {getPlanDisplayName(membershipName || "")}
                </p>
              </div>
            </div>
          </section>
